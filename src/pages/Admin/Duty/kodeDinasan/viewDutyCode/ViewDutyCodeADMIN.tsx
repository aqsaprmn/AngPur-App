...
const ViewDutyCodeADMIN = () => {
  ...
  return (
    <form className="bg-white px-4 py-4 rounded-lg min-h-[80vh] relative">
      <div className="mb-3">
      ...
      <div className="flex justify-end gap-2 min-h-full items-end absolute bottom-7 right-7">
        <MainCustomButton type="button" onClick={() => navigate(-1)}>
          Kembali
        </MainCustomButton>
      </div>
    </form>
...
export default ViewDutyCodeADMIN;
